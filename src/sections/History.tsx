...
const ITEMS = [
    ...
    { year: "2024 / 11", text: "AtCoderで茶色到達。ここから長期インターンにのめり込み、ほとんど大会に参加しなくなってしまう。" },
    { year: "2024 / 10", text: "Onplanetz株式会社を退社。" },
    { year: "2024 / 8", text: "Onplanetz株式会社に長期インターンシップとして入社し、画像認識系のプロジェクトに従事。" },
    { year: "2024 / 5", text: "Pythonを学ぼうと、競技プログラミング「AtCoder」を始める。2カ月ほどで茶色手前まで行ったが、卒業研究が本格的に始まり約半年間停滞する。" },
